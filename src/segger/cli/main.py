...
def segment(
    ...
    # Cell Representation
    node_representation_dim: Annotated[
        int,
        Parameter(
    ...
    cells_representation: Annotated[
        Literal["pca", "morphology"],
        registry.get_parameter(
            "cells_representation_mode",
            group=group_nodes,
        ),
    ] = registry.get_default("cells_representation_mode"),
    cells_min_counts: Annotated[
        int,
        registry.get_parameter(
            "cells_min_counts",
    ...
    cells_clusters_n_neighbors: Annotated[
        int,
        registry.get_parameter(
    ...
    cells_clusters_resolution: Annotated[
        float,
        registry.get_parameter(
    ...
    # Gene Representation
    genes_clusters_n_neighbors: Annotated[
        int,
        registry.get_parameter(
    ...
    genes_clusters_resolution: Annotated[
        float,
        registry.get_parameter(
    ...
    transcripts_max_dist: Annotated[
        float,
        registry.get_parameter(
    ...
    prediction_expansion_ratio: Annotated[
        float | None,
        registry.get_parameter(
    ...
    # Tiling
    tiling_margin_training: Annotated[
        float,
        registry.get_parameter(
    ...
    tiling_margin_prediction: Annotated[
        float,
        registry.get_parameter(
    ...
    use_positional_embeddings: Annotated[
        bool,
        registry.get_parameter(
    ...
    transcripts_loss_weight_start: Annotated[
        float,
        registry.get_parameter(
            "tx_weight_start",
            validator=validators.Number(gte=0),
    ...
    transcripts_loss_weight_end: Annotated[
        float,
        registry.get_parameter(
            "tx_weight_end",
            validator=validators.Number(gte=0),
    ...
    cells_loss_weight_start: Annotated[
        float,
        registry.get_parameter(
            "bd_weight_start",
            validator=validators.Number(gte=0),
    ...
    cells_loss_weight_end: Annotated[
        float,
        registry.get_parameter(
            "bd_weight_end",
            validator=validators.Number(gte=0),
    ...
    segmentation_loss_weight_start: Annotated[
        float,
        registry.get_parameter(
            "sg_weight_start",
            validator=validators.Number(gte=0),
    ...
    segmentation_loss_weight_end: Annotated[
        float,
        registry.get_parameter(
            "sg_weight_end",
            validator=validators.Number(gte=0),
